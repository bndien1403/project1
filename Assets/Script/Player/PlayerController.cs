...
namespace SazenGames.Skeleton
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        public float _lockedTill; // Biến dùng để khóa logic chuyển đổi trong thời gian ngắn
        ...
        public void ChangeAnimationState(string newState, float transitionTime = 0.1f)
        {
      ...
      public   bool IsPlayingAction()
        {
            ...
            if (stateInfo.IsName(ANIM_IDLE) || stateInfo.IsName(ANIM_RUN) || stateInfo.IsName(ANIM_SPAWN))
            {
